...
export default function ContentDetailPage() {
  ...
  }, [contentId, authentication, isConnected, connect, subscribe, unsubscribe, addMessage, clearMessages, fetchWatchingSessions, addWatchingSession, removeWatchingSession]);
